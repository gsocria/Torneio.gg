...
<body>
                ...
                <div class="container mx-auto px-4">
                    <div class="flex items-center justify-between py-4">
                        ...
                        <div class="hidden sm:flex sm:items-center">
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mr-4">Home</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mr-4">Noticias</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mr-4">Campeonatos</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300">Sobre</a>
                        </div>

                        <div class="hidden sm:flex sm:items-center">
                            <button id="login_open" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mr-4">Login</button>

                            <div id="login_panel" class="main-modal fixed w-full inset-0 z-50 overflow-hidden flex justify-center items-center hidden">
                                <div class="modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl z-50 overflow-y-auto">
                                    <div class="modal-content py-4 text-left px-6">
                                        <div class="flex justify-between items-center pb-3">
                                            <p class="text-2xl font-bold text-black-500">Login</p>
                                            <div id="login_close" class="modal-close cursor-pointer z-50">
                    ...
                    <div class="block sm:hidden bg-white border-t-2 py-2">
                        <div class="flex flex-col">
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mb-1">Products</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mb-1">Marketplace</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mb-1">Partners</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-yellow-300 mb-1">Pricing</a>
    ...
    <section class="main h-screen">
        ...
        <div class="foto">
            <img class="w-full" src="./img/fotor_2023-5-23_16_29_14.png" alt="">
        </div>
